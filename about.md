...
<div style="background-image: url('assets/images/banners/About-me.jpg'); background-size: cover; background-position: center; height: 90vh; width: 85vw; display: flex; justify-content: center; align-items: center; margin-left: auto; margin-right: auto; padding: 0; overflow: hidden; border-radius: 15px; padding-left: 5px;"> <!-- Reduced padding-left -->
